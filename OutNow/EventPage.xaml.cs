...
namespace OutNow
{
    ...
    public sealed partial class EventPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            this.ThemesComboBox.ItemsSource = ThemeDatas.Themes;
        }
        ...
        protected async override void OnNavigatedFrom(NavigationEventArgs e)
        {
            if (modified)
            {
                try
                {
                    ...
                    Uri eventURL = new Uri("http://169.254.80.80:8081/databases/OutNow/docs/" + currentEvent.Metadata.Id);
                    httpClient.DefaultRequestHeaders.Add("Raven-Entity-Name", "Event");
                    var cts = new CancellationTokenSource();
                    //var update = new Update();
                    StringContent queryString = new StringContent(currentEvent.ToJson<Event>());
                    HttpResponseMessage response = await httpClient.PutAsync(eventURL, queryString);
